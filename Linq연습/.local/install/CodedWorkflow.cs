...
namespace Linq연습
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        ...
        {
            _ = new System.Type[]{typeof(UiPath.UIAutomationNext.API.Contracts.IRuntimeTargetAppSyncFactory), typeof(UiPath.Core.Activities.API.ISystemService), typeof(UiPath.Testing.API.ITestingService)};
        }
